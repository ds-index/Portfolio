...
export default function Skills() {
  const categories = [
    ...
    },
    {
      ...
      items: [
        { name: "Microservice", level: "Basic" },
        { name: "Software Architecture", level: "Basic" },
        { name: "Design Patterns", level: "Basic" },
        { name: "Clean Code", level: "Basic" },
        { name: "Repository Pattern", level: "Basic" },
        { name: "UnitOfWork Pattern", level: "Basic" },
        { name: "CQRS", level: "Basic" },
        { name: "Vertical Design", level: "Basic" },
        { name: "DI", level: "Basic" },
        { name: "DDD", level: "Basic" },
      ],
    },
    {
      key: "Learning",
      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-8 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-base text-slate-300 sm:text-lg">
            A practical overview of the tools, frameworks, and engineering
