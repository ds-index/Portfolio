      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-8 rounded-[2rem] border border-white/10 bg-slate-900/70 p-6 shadow-[0_30px_80px_rgba(0,0,0,0.35)] backdrop-blur-xl md:flex-row md:items-center md:justify-between md:p-10 lg:p-14">
        <div className="max-w-2xl text-center md:text-left">
          ...
          <p className="mt-5 text-base leading-8 text-slate-300 sm:text-lg">
            .NET Developer with experience building backend and full-stack web
            applications using ASP.NET Core, Angular, and SQL Server. Passionate
            about backend engineering and currently deepening expertise in
            software architecture, system design, cloud technologies, and DevOps
            practices. Focused on developing clean, maintainable, and scalable
            software solutions
          </p>
        ...
        <div className="flex flex-1 items-center gap-3 rounded-2xl border border-indigo-400/20 bg-gradient-to-r from-indigo-500/10 to-violet-500/10 p-4 shadow-lg shadow-indigo-950/20 backdrop-blur">
          ...
          <div>
            ...
            <p className="text-sm text-slate-300">
              Scalable architecture, cloud-native technologies, system
              reliability, and infrastructure automation.
            </p>
          </div>
        </div>
